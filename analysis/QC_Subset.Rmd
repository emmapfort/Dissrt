...
# saveRDS(metadata, "data/counts/metadata_updated.RDS")
...
```{r Remove extra samples, message=FALSE, warning=FALSE, echo=FALSE, include=FALSE}
...
#I want to also remove an outlier sample based on my initial PCA analysis - PFOA_24_H3 is not clustering with other samples.
...
dim(hc_cpm_matrix)
#15,321 genes after filtering by rowMeans > 0
...
# dim(cpm_filtered)
# #total of 11997 genes with stringent filter
...
#now I want to remove an outlier sample that is not clustering with the rest of the samples
#PFOA 24 H3 is not clustering properly
