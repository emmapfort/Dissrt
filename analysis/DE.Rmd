...
I want to further delve into my analysis by looking at differences between species after treatment. I will do this using an interaction analysis to assess Species x Condition interactions. 

```{r interaction analysis}
#Set up my model matrix for THA for now, and then branch out to other treatments
...
design <- model.matrix(~sp*stim + meta_de$Cond)
colnames(design) <- gsub("meta_de\\$Cond", "", colnames(design))
