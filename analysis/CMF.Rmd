...
hc_cpm_matrix <- hc_cpm_matrix %>% as.data.frame() %>% 
  dplyr::select(-PFOA_24_H3)

as.matrix(hc_cpm_matrix)
...
# saveRDS(expr, "data/cmf/cormotif_reordered_cpm_matrix_rmoutlier.RDS")

expr <- readRDS("data/cmf/cormotif_reordered_cpm_matrix_rmoutlier.RDS")
...
metadata <- metadata[match(colnames(hc_cpm_matrix), metadata$Final_sample_name), ]

# --- Biuild group and comp IDs from metadata ---
